#############################################################################
# Makefile for building: mak
# Generated by qmake (2.01a) (Qt 4.7.4) on: dom 22. Jan 19:15:33 2012
# Project:  mak.pro
# Template: app
# Command: c:/qtsdk/madde/targets/harmattan_10.2011.34-1/bin/qmake.exe -spec c:/QtSDK/Madde/sysroots/harmattan_sysroot_10.2011.34-1_slim/usr/share/qt4/mkspecs/default -unix -after  OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc -o Makefile mak.pro
#############################################################################
...
Makefile: mak.pro  c:/QtSDK/Madde/sysroots/harmattan_sysroot_10.2011.34-1_slim/usr/share/qt4/mkspecs/default/qmake.conf c:/QtSDK/Madde/sysroots/harmattan_sysroot_10.2011.34-1_slim/usr/share/qt4/mkspecs/common/g++.conf \
		c:/QtSDK/Madde/sysroots/harmattan_sysroot_10.2011.34-1_slim/usr/share/qt4/mkspecs/common/unix.conf \
		c:/QtSDK/Madde/sysroots/harmattan_sysroot_10.2011.34-1_slim/usr/share/qt4/mkspecs/common/linux.conf \
		c:/QtSDK/Madde/sysroots/harmattan_sysroot_10.2011.34-1_slim/usr/share/qt4/mkspecs/qconfig.pri \
		c:/QtSDK/Madde/sysroots/harmattan_sysroot_10.2011.34-1_slim/usr/share/qt4/mkspecs/features/qt_functions.prf \
	...
	$(QMAKE) -spec c:/QtSDK/Madde/sysroots/harmattan_sysroot_10.2011.34-1_slim/usr/share/qt4/mkspecs/default -unix -after  OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc -o Makefile mak.pro
...
dist: 
	@$(CHK_DIR_EXISTS) obj/mak1.0.0 || $(MKDIR) obj/mak1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/mak1.0.0/ && $(COPY_FILE) --parents qmlapplicationviewer/qmlapplicationviewer.h obj/mak1.0.0/ && $(COPY_FILE) --parents main.cpp qmlapplicationviewer/qmlapplicationviewer.cpp obj/mak1.0.0/ && (cd `dirname obj/mak1.0.0` && $(TAR) mak1.0.0.tar mak1.0.0 && $(COMPRESS) mak1.0.0.tar) && $(MOVE) `dirname obj/mak1.0.0`/mak1.0.0.tar.gz . && $(DEL_FILE) -r obj/mak1.0.0
...
install_itemfolder_01: first FORCE
	@$(CHK_DIR_EXISTS) $(INSTALL_ROOT)/opt/mak/qml/ || $(MKDIR) $(INSTALL_ROOT)/opt/mak/qml/ 
	-$(INSTALL_DIR) c:/Users/flavio/Documents/Qt_Projects/mak_2011-11-17_FINAL_Meego/qml/mak $(INSTALL_ROOT)/opt/mak/qml/


uninstall_itemfolder_01:  FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/opt/mak/qml/mak
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/mak/qml/ 
...
install_icon: first FORCE
	...
	-$(INSTALL_FILE) c:/Users/flavio/Documents/Qt_Projects/mak_2011-11-17_FINAL_Meego/mak80.png $(INSTALL_ROOT)/usr/share/icons/hicolor/80x80/apps/


uninstall_icon:  FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/icons/hicolor/80x80/apps/mak80.png
...
install_desktopfile: first FORCE
	...
	-$(INSTALL_FILE) c:/Users/flavio/Documents/Qt_Projects/mak_2011-11-17_FINAL_Meego/mak_harmattan.desktop $(INSTALL_ROOT)/usr/share/applications/


uninstall_desktopfile:  FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/applications/mak_harmattan.desktop
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/applications/ 


install_target: first FORCE
	@$(CHK_DIR_EXISTS) $(INSTALL_ROOT)/opt/mak/bin/ || $(MKDIR) $(INSTALL_ROOT)/opt/mak/bin/ 
	-$(INSTALL_PROGRAM) "$(QMAKE_TARGET)" "$(INSTALL_ROOT)/opt/mak/bin/$(QMAKE_TARGET)"

uninstall_target:  FORCE
	-$(DEL_FILE) "$(INSTALL_ROOT)/opt/mak/bin/$(QMAKE_TARGET)"
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/mak/bin/ 
